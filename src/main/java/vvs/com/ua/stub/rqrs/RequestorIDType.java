 ...
 *       &lt;sequence>
 *         &lt;element name="CompanyName" type="{http://services.sabre.com/sp/eab/v3_8}CompanyNameType" minOccurs="0"/>
 *         &lt;element name="ArrangerDetails" type="{http://services.sabre.com/sp/eab/v3_8}ArrangerDetailsType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "RequestorIDType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "companyName",
    "arrangerDetails"
})
public class RequestorIDType {

    @XmlElement(name = "CompanyName", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected CompanyNameType companyName;
    @XmlElement(name = "ArrangerDetails", namespace = "http://services.sabre.com/sp/eab/v3_8")
