 ...
 *       &lt;sequence>
 *         &lt;element name="RequestorID" type="{http://services.sabre.com/sp/eab/v3_8}RequestorIDType" minOccurs="0"/>
 *         &lt;element name="BookingChannel" type="{http://services.sabre.com/sp/eab/v3_8}BookingChannelType" minOccurs="0"/>
 *         &lt;element name="TTYRecordLocator" type="{http://services.sabre.com/sp/eab/v3_8}TTYRecordLocatorType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="OAC" type="{http://services.sabre.com/sp/eab/v3_8}OACType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "SourceType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "requestorID",
    "bookingChannel",
    "ttyRecordLocator",
    "oac"
...
public class SourceType {
    ...
    @XmlElement(name = "RequestorID", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected RequestorIDType requestorID;
    @XmlElement(name = "BookingChannel", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected BookingChannelType bookingChannel;
    @XmlElement(name = "TTYRecordLocator", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected List<TTYRecordLocatorType> ttyRecordLocator;
    @XmlElement(name = "OAC", namespace = "http://services.sabre.com/sp/eab/v3_8")
