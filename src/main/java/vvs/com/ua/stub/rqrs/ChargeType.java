 ...
 *         &lt;element name="Calculation" type="{http://services.sabre.com/sp/eab/v3_8}CalculationType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "ChargeType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "description",
    "notes",
    "name",
    "calculation",
...
public class ChargeType {
    ...
    @XmlElement(name = "Description", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String description;
    @XmlElement(name = "Notes", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String notes;
    @XmlElement(name = "Name", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String name;
    @XmlElement(name = "Calculation", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected List<CalculationType> calculation;
    @XmlElement(name = "BillingType", namespace = "http://services.sabre.com/sp/eab/v3_8")
