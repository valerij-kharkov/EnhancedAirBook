...
@XmlType(name = "PersonNameType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "prefix",
    "given",
    "middle",
    "surname",
...
public class PersonNameType {
    ...
    @XmlElement(name = "Prefix", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String prefix;
    @XmlElement(name = "Given", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String given;
    @XmlElement(name = "Middle", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String middle;
    @XmlElement(name = "Surname", namespace = "http://services.sabre.com/sp/eab/v3_8", required = true)
    protected String surname;
    @XmlElement(name = "Suffix", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String suffix;
    @XmlElement(name = "Type", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String type;
    @XmlElement(name = "PreferredFirstName", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String preferredFirstName;
    @XmlElement(name = "PreferredSurname", namespace = "http://services.sabre.com/sp/eab/v3_8")
