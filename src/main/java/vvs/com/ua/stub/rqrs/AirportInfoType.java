 ...
 *       &lt;sequence>
 *         &lt;element name="Airline" type="{http://services.sabre.com/sp/eab/v3_8}AirlineType" minOccurs="0"/>
...
@XmlType(name = "AirportInfoType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "airline",
    "airportName",
    "locationCode",
    "terminal",
...
public class AirportInfoType {
    ...
    @XmlElement(name = "Airline", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected AirlineType airline;
    @XmlElement(name = "AirportName", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String airportName;
    @XmlElement(name = "LocationCode", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String locationCode;
    @XmlElement(name = "Terminal", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String terminal;
    @XmlElement(name = "Gate", namespace = "http://services.sabre.com/sp/eab/v3_8")
