 ...
 *       &lt;sequence>
 *         &lt;element name="PersonName" type="{http://services.sabre.com/sp/eab/v3_8}PersonNameType"/>
...
@XmlType(name = "ArrangerDetailsType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "personName",
    "telephone",
    "email"
})
public class ArrangerDetailsType {
    ...
    @XmlElement(name = "PersonName", namespace = "http://services.sabre.com/sp/eab/v3_8", required = true)
