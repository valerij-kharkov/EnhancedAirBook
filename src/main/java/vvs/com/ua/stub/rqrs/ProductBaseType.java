...
@XmlType(name = "ProductBaseType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "productType",
    "vendorCode",
    "statusCode",
    "startPoint",
...
public class ProductBaseType {
    ...
    @XmlElement(name = "ProductType", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String productType;
    @XmlElement(name = "VendorCode", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String vendorCode;
    @XmlElement(name = "StatusCode", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String statusCode;
    @XmlElement(name = "StartPoint", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String startPoint;
    @XmlElement(name = "StartDateTime", namespace = "http://services.sabre.com/sp/eab/v3_8")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar startDateTime;
    @XmlElement(name = "EndPoint", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String endPoint;
    @XmlElement(name = "EndDateTime", namespace = "http://services.sabre.com/sp/eab/v3_8")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar endDateTime;
    @XmlElement(name = "Text", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected List<String> text;
    @XmlElement(name = "SegmentReference", namespace = "http://services.sabre.com/sp/eab/v3_8")
