...
@XmlType(name = "MultilineTextType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "textLine"
})
public class MultilineTextType {

    @XmlElement(name = "TextLine", namespace = "http://services.sabre.com/sp/eab/v3_8", required = true)
