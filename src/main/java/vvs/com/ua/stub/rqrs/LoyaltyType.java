 ...
 *         &lt;element name="LoyaltyLevel" type="{http://services.sabre.com/sp/eab/v3_8}CodeDescriptionType" minOccurs="0"/>
...
@XmlType(name = "LoyaltyType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "programName",
    "membershipID",
    "loyaltyLevel",
    "effectiveDate",
...
public class LoyaltyType {
    ...
    @XmlElement(name = "ProgramName", namespace = "http://services.sabre.com/sp/eab/v3_8", required = true)
    protected String programName;
    @XmlElement(name = "MembershipID", namespace = "http://services.sabre.com/sp/eab/v3_8", required = true)
    protected String membershipID;
    @XmlElement(name = "LoyaltyLevel", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected CodeDescriptionType loyaltyLevel;
    @XmlElement(name = "EffectiveDate", namespace = "http://services.sabre.com/sp/eab/v3_8")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar effectiveDate;
    @XmlElement(name = "ExpireDate", namespace = "http://services.sabre.com/sp/eab/v3_8")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar expireDate;
    @XmlElement(name = "Remark", namespace = "http://services.sabre.com/sp/eab/v3_8")
