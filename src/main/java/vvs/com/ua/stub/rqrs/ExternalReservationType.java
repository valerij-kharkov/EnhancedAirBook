...
@XmlType(name = "ExternalReservationType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "sourceSystem",
    "confirmationNumber",
    "cancellationNumber",
    "referenceNumber",
...
public class ExternalReservationType {
    ...
    @XmlElement(name = "SourceSystem", namespace = "http://services.sabre.com/sp/eab/v3_8", required = true)
    protected String sourceSystem;
    @XmlElement(name = "ConfirmationNumber", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String confirmationNumber;
    @XmlElement(name = "CancellationNumber", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String cancellationNumber;
    @XmlElement(name = "ReferenceNumber", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String referenceNumber;
    @XmlElement(name = "ReservationStatus", namespace = "http://services.sabre.com/sp/eab/v3_8")
