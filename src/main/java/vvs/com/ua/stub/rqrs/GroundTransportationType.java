 ...
 *         &lt;element name="Vendor" type="{http://services.sabre.com/sp/eab/v3_8}CompanyType" minOccurs="0"/>
 *         &lt;element name="Service" type="{http://services.sabre.com/sp/eab/v3_8}ServiceType" minOccurs="0"/>
 *         &lt;element name="ServiceProvider" type="{http://services.sabre.com/sp/eab/v3_8}ServiceProviderType" minOccurs="0"/>
 ...
 *         &lt;element name="ExternalReservation" type="{http://services.sabre.com/sp/eab/v3_8}ExternalReservationType" minOccurs="0"/>
 *         &lt;element name="Restrictions" type="{http://services.sabre.com/sp/eab/v3_8}RestrictionsType" minOccurs="0"/>
 *         &lt;element name="POS" type="{http://services.sabre.com/sp/eab/v3_8}POSType"/>
 *         &lt;element name="AgentLoyalty" type="{http://services.sabre.com/sp/eab/v3_8}LoyaltyType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Passenger" type="{http://services.sabre.com/sp/eab/v3_8}PassengerType" maxOccurs="99" minOccurs="0"/>
 *         &lt;element name="RateQualifier" type="{http://services.sabre.com/sp/eab/v3_8}RateQualifierType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "GroundTransportationType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "statusCode",
    "vendor",
    "service",
    "serviceProvider",
...
public class GroundTransportationType {
    ...
    @XmlElement(name = "Vendor", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected CompanyType vendor;
    @XmlElement(name = "Service", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected ServiceType service;
    @XmlElement(name = "ServiceProvider", namespace = "http://services.sabre.com/sp/eab/v3_8")
    ...
    @XmlElement(name = "ExternalReservation", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected ExternalReservationType externalReservation;
    @XmlElement(name = "Restrictions", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected RestrictionsType restrictions;
    @XmlElement(name = "POS", namespace = "http://services.sabre.com/sp/eab/v3_8", required = true)
    protected POSType pos;
    @XmlElement(name = "AgentLoyalty", namespace = "http://services.sabre.com/sp/eab/v3_8")
    ...
    @XmlElement(name = "RateQualifier", namespace = "http://services.sabre.com/sp/eab/v3_8")
