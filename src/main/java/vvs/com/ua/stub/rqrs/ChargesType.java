 ...
 *         &lt;element name="Charge" type="{http://services.sabre.com/sp/eab/v3_8}ChargeType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="GrandTotal" type="{http://services.sabre.com/sp/eab/v3_8}MoneyType" minOccurs="0"/>
...
@XmlType(name = "ChargesType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "generalNotes",
    "charge",
    "grandTotal",
    "generalBillingType"
...
public class ChargesType {
    ...
    @XmlElement(name = "GeneralNotes", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String generalNotes;
    @XmlElement(name = "Charge", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected List<ChargeType> charge;
    @XmlElement(name = "GrandTotal", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected MoneyType grandTotal;
    @XmlElement(name = "GeneralBillingType", namespace = "http://services.sabre.com/sp/eab/v3_8")
