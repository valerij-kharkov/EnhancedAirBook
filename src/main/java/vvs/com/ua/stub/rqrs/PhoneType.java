...
@XmlType(name = "PhoneType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "phoneUseType",
    "phoneCountryCode",
    "phoneCountryName",
    "phoneNumber"
...
public class PhoneType {
    ...
    @XmlElement(name = "PhoneUseType", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String phoneUseType;
    @XmlElement(name = "PhoneCountryCode", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String phoneCountryCode;
    @XmlElement(name = "PhoneCountryName", namespace = "http://services.sabre.com/sp/eab/v3_8")
    protected String phoneCountryName;
    @XmlElement(name = "PhoneNumber", namespace = "http://services.sabre.com/sp/eab/v3_8", required = true)
