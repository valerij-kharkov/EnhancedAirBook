...
@XmlType(name = "SupplementaryServiceType", namespace = "http://services.sabre.com/sp/eab/v3_8", propOrder = {
    "description",
    "charges",
    "passengerReferences"
})
public class SupplementaryServiceType {
    ...
    @XmlElement(name = "Description", namespace = "http://services.sabre.com/sp/eab/v3_8", required = true)
